from manim import *
from utils import CNNBaseScene, text_to_speech
import numpy as np
import os
...
class TitleScene(CNNBaseScene):
    ...
    def construct(self):
        ...
        # Animation sequence
        narration_text = """Welcome! Today we'll see how convolutional neural networks—CNNs—power modern 
        ...
        os.makedirs("cnn_video/audio", exist_ok=True)
        
        # Option 1: Use manim-voiceover (preferred)
        with self.voiceover(narration_text):
